...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { code: @code.code, company_id: @code.company_id, destination: @code.destination, facility_type: @code.facility_type, name: @code.name } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { code: @code.code, company_id: @code.company_id, destination: @code.destination, facility_type: @code.facility_type, name: @code.name } }
